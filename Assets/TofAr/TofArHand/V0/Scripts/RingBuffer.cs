...
namespace TofAr.V0.Hand
{
    ...
    public class RingBuffer
    {
        ...
        private void FillInternal(Vector3[] points, RecognizeResultProperty handData, HandStatus hand)
        {
            ...
            PoseIndex poseIndex = (PoseIndex)RingBufferInternal.GetMaximum(poseLevels);
            ...
            for (int i = 0; i < nPoints; i++)
            {
                ...
                {
                    worldPoint = RingBufferInternal.RotateAccordingToAcceleration(worldPoint, points[(int)HandPointIndex.HandCenter], this.imageRotation);
                }
